...
CONFIG = {
    ...
    "action_model_path": "weight/attention_lstm_model.pth",  # 兜底模型路径
    ...
    # --- 输入源 ---
    # 0 代表默认摄像头, 或者填入视频文件路径, 例如 "D:/videos/test.mp4"
    "video_source": 0,

    # --- 模型参数 (兼容新训练的合并版模型) ---
    "sequence_length": 150,  # 与新模型训练时保持一致
    "num_keypoints": 17,
...
class AttentionLSTM(nn.Module):
    ...
    def __init__(self, input_size=68, hidden_size=128, num_layers=2, num_classes=8, dropout=0.25, use_attention=True):
